...
This cookbook now exposes custom resources only. Recipes and node attributes were removed. See [migration.md](migration.md) for the migration guide.

## Resources

* [nexus_install](documentation/nexus_install.md)
* [nexus_user](documentation/nexus_user.md)
* [nexus_hosted_repository](documentation/nexus_hosted_repository.md)
* [nexus_proxy_repository](documentation/nexus_proxy_repository.md)
* [nexus_group_repository](documentation/nexus_group_repository.md)
